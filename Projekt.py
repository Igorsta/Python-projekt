...
def main():
    ...
    parser.add_argument(
        ...
        help=f"Opcjonalna lista czasów (w formacie {all_times}). Domyślna wartość to {default_time}."
    )
    ...
    struktura= generuj_strukture_plików(args.months, args.days, args.times)
